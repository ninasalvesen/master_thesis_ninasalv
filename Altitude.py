...
print(start1, first1, second1, end1, len(df1))
...
threads = [Thread(target=InsertAltitude, args=(df_test1, start1, first1)), Thread(target=InsertAltitude, args=(df_test2, first1, second1)),
